...
public class Parallaxing : MonoBehaviour
{
    ...
    private float[] parallaxScales;     // Proportion of the cameras movement to move the back and foreground by.
    public float smoothing = 1f;        // How smooth the parallax is going to be. Make sure to set this above 0.


    private Transform cam;              // Reference to the main camera's transfrom.
    ...
    void Update()
    {
        ...
        for (int i = 0; i < backgrounds.Length; i++)
        {
            ...
            // create a target position which is the background's current postion with it's target x position
